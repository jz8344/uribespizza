...
function sendWhatsapp () {
  ...
  const url = `https://api.whatsapp.com/send?phone=${WA_PHONE}&text=${text}`
  ...
  <section class="hero" id="inicio">
    <div class="container hero-inner">
      <div>
        ...
        <div class="hero-ctas">
          <a class="btn btn-wa" href="https://api.whatsapp.com/send?phone=523335992647&text=Hola%20Uribe%27s%20Pizza!%20Quiero%20hacer%20un%20pedido%20%F0%9F%8D%95" target="_blank" rel="noopener">
